...
{
    internal class UpdateCardPictureMessageHandler : BaseMessageHandler<UpdateCardPictureMessage>
    {
        ...
        public override async Task HandleAsync(UpdateCardPictureMessage message)
        {
