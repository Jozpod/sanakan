CREATE TABLE `users` (
  ...
  `StatsReplacementProfileUri` varchar(50) DEFAULT NULL,
  ...
  CONSTRAINT `CK_Users_BackgroundProfileUri` CHECK (((trim(`BackgroundProfileUri`) <> _utf8mb4'') or (`BackgroundProfileUri` is null))),
  CONSTRAINT `CK_Users_StatsReplacementProfileUri` CHECK (((trim(`StatsReplacementProfileUri`) <> _utf8mb4'') or (`StatsReplacementProfileUri` is null)))
