...
namespace Sanakan.DAL.Models
{
    public class Figure
    {
        ...
        public Quality GetQualityOfPart(FigurePart part)
        {
            return part switch
            {
                FigurePart.Body => BodyQuality,
                FigurePart.Clothes => ClothesQuality,
                FigurePart.Head => HeadQuality,
                FigurePart.LeftArm => LeftArmQuality,
                FigurePart.LeftLeg => LeftLegQuality,
                FigurePart.RightArm => RightArmQuality,
                FigurePart.RightLeg => RightLegQuality,
                _ => Quality.Broken
            };
        }
