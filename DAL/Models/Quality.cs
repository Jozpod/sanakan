namespace Sanakan.DAL.Models
{
    ...
    public static class QualityExtensions
    {
        ...
        public static double ToValue(this Quality quality) => 1 + (int) quality * 0.1;

        public static string ToName(this Quality quality, string? broken = null) => quality switch
        {
            Quality.Alpha => "α",
            Quality.Beta => "β",
            Quality.Gamma => "γ",
