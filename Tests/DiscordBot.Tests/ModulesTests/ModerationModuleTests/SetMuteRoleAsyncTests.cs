...
{
    /// <summary>
    /// Defines tests for <see cref="ModerationModule.SetMuteRoleAsync(IRole)"/> method.
    /// </summary>
    [TestClass]
    public class SetMuteRoleAsyncTests : Base
    {
        [TestMethod]
        public async Task Should_Set_Role_And_Send_Confirm_Message()
        {
            ...
            await _module.SetMuteRoleAsync(roleMock.Object);
        }
    }
}
